#!/usr/bin/env python3
"""
Visualize ECMC test particle configurations
Read .dat files and plot particle disks
"""
...
if __name__ == "__main__":
    ...
    search_dirs = [
        ...
        "../build",             # build in parent directory
        os.path.dirname(__file__) + "/build",  # build in script directory
    ]
